...
void gedatsu_merge_distval_R_c_test()
{
  ...
  monolis_std_log_string("gedatsu_graph_merge_c_test distval_R");
...
void gedatsu_merge_distval_I_c_test()
{
  ...
  monolis_std_log_string("gedatsu_graph_merge_c_test distval_I");
...
void gedatsu_merge_distval_C_c_test()
{
  ...
  monolis_std_log_string("gedatsu_graph_merge_c_test distval_C");
