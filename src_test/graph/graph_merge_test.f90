...
module mod_gedatsu_graph_merge_test
  ...
  subroutine gedatsu_merge_nodal_subgraphs_test()
    ...
    integer(kint) :: exp_0, exp_1, exp_2, exp_3, exp_4, exp_5, exp_6
    integer(kint) :: exp_7, exp_8, exp_9, exp_12, exp_14, exp_15, exp_18, exp_22
    ...
    call gedatsu_graph_set_n_vertex(graphs(1), exp_5)
    call gedatsu_graph_set_n_vertex(graphs(2), exp_5)
    call gedatsu_graph_set_n_vertex(graphs(3), exp_6)
    ...
    call monolis_alloc_I_2d(edge, exp_2, exp_14)
    ...
    call gedatsu_graph_set_edge(graphs(1), exp_14, edge, .true.)
    ...
    edge(1,13) = 5; edge(2,13) = 2
    edge(1,14) = 5; edge(2,14) = 4
    call gedatsu_graph_set_edge(graphs(2), exp_14, edge, .true.)

    call monolis_dealloc_I_2d(edge)
    call monolis_alloc_I_2d(edge, exp_2, exp_18)
    edge(1,1) = 1; edge(2,1) = 2
    edge(1,2) = 1; edge(2,2) = 3
    edge(1,3) = 1; edge(2,3) = 4
    edge(1,4) = 1; edge(2,4) = 5
    ...
    call gedatsu_graph_set_edge(graphs(3), exp_18, edge, .true.)
    ...
    !> 結合
    call gedatsu_merge_nodal_subgraphs(exp_3, graphs, monoCOMs, merged_graph, merged_monoCOM, ORDER_DOMAIN_ID)

    !> 結合結果の確認
    call monolis_test_check_eq_I1("gedatsu_graph_merge_test nodal_graph case1 ORDER_DOMAIN_ID n_vertex", &
    & merged_graph%n_vertex, exp_7)
    call monolis_test_check_eq_I1("gedatsu_graph_merge_test nodal_graph case1 ORDER_DOMAIN_ID n_internal_vertex", &
    & merged_graph%n_internal_vertex, exp_5)
    call monolis_alloc_I_1d(check_vertex_domain_id, exp_7)
    ...
    call monolis_alloc_I_1d(check_vertex_id, exp_7)
    check_vertex_id(1) = 1
    check_vertex_id(2) = 4
    check_vertex_id(3) = 2
    check_vertex_id(4) = 3
    ...
    call monolis_alloc_I_1d(check_index, exp_8)
    check_index(1) = 0
    check_index(2) = 2
    check_index(3) = 6
    check_index(4) = 10
    ...
    call monolis_alloc_I_1d(check_item, exp_22)
    check_item(1) = 2
    check_item(2) = 3
    check_item(3) = 1
    check_item(4) = 3
    ...
    !> 結合
    call gedatsu_merge_nodal_subgraphs(exp_3, graphs, monoCOMs, merged_graph, merged_monoCOM, ORDER_NODAL_ID)
  ...
  subroutine gedatsu_merge_connectivity_subgraphs_test()
    ...
    integer(kint) :: exp_0, exp_1, exp_2, exp_3, exp_4, exp_5, exp_6, exp_9
    integer(kint) :: exp_12, exp_14, exp_15, exp_18
    ...
    call gedatsu_graph_set_n_vertex(nodal_graphs(1), exp_5)
    call gedatsu_graph_set_n_vertex(nodal_graphs(2), exp_5)
    call gedatsu_graph_set_n_vertex(nodal_graphs(3), exp_6)
    ...
    edge(1,13) = 5; edge(2,13) = 2
    edge(1,14) = 5; edge(2,14) = 4
    call gedatsu_graph_set_edge(nodal_graphs(1), exp_14, edge, .true.)
    ...
    edge(1,13) = 5; edge(2,13) = 2
    edge(1,14) = 5; edge(2,14) = 4
    call gedatsu_graph_set_edge(nodal_graphs(2), exp_14, edge, .true.)
    ...
    edge(1,17) = 6; edge(2,17) = 1
    edge(1,18) = 6; edge(2,18) = 5
    call gedatsu_graph_set_edge(nodal_graphs(3), exp_18, edge, .true.)

    call monolis_com_initialize_by_self(monoCOMs(1))
    call monolis_com_initialize_by_self(monoCOMs(2))
    call monolis_com_initialize_by_self(monoCOMs(3))

    call gedatsu_merge_nodal_subgraphs(exp_3, nodal_graphs, monoCOMs, merged_nodal_graph, merged_monoCOM, ORDER_DOMAIN_ID)
    ...
    call gedatsu_graph_set_n_vertex(conn_graphs(1), exp_3)
    call gedatsu_graph_set_n_vertex(conn_graphs(2), exp_3)
    call gedatsu_graph_set_n_vertex(conn_graphs(3), exp_4)
    ...
    call monolis_dealloc_I_2d(edge)
    call monolis_alloc_I_2d(edge, exp_2, exp_9)
    ...
    call gedatsu_graph_set_edge(conn_graphs(1), exp_9, edge, .false.)
    ...
    edge(1,9) = 3; edge(2,9) = 4
    call gedatsu_graph_set_edge(conn_graphs(2), exp_9, edge, .false.)

    call monolis_dealloc_I_2d(edge)
    call monolis_alloc_I_2d(edge, exp_2, exp_12)
    edge(1,1) = 1; edge(2,1) = 1
    ...
    call gedatsu_graph_set_edge(conn_graphs(3), exp_12, edge, .false.)

    call gedatsu_merge_connectivity_subgraphs(exp_3, nodal_graphs, merged_nodal_graph, merged_monoCOM, &
    & exp_3, conn_graphs, merged_conn_graph)

    !> 結合結果の確認
    call monolis_test_check_eq_I1("gedatsu_graph_merge_test conn_graph case1 n_vertex", merged_conn_graph%n_vertex, exp_5)
    call monolis_test_check_eq_I1("gedatsu_graph_merge_test conn_graph case1 n_internal_vertex", &
    & merged_conn_graph%n_internal_vertex, exp_5)
    call monolis_dealloc_I_1d(check_vertex_domain_id)
    call monolis_alloc_I_1d(check_vertex_domain_id, exp_5)
    ...
    call monolis_alloc_I_1d(check_vertex_id, exp_5)
    check_vertex_id(1) = 1
    check_vertex_id(2) = 2
    check_vertex_id(3) = 3
    check_vertex_id(4) = 4
    ...
    call monolis_alloc_I_1d(check_index, exp_6)
    check_index(1) = 0
    check_index(2) = 3
    check_index(3) = 6
    check_index(4) = 9
    ...
    call monolis_alloc_I_1d(check_item, exp_15)
    check_item(1) = 1
    check_item(2) = 3
    check_item(3) = 2
    check_item(4) = 2
  ...
  subroutine gedatsu_merge_distval_R_test()
    ...
    integer(kint) :: exp_2, exp_3, exp_5, exp_6, exp_7, exp_8, exp_14, exp_18
    ...
    n_dof_list(2)%n = 5
    n_dof_list(3)%n = 6
    call monolis_alloc_I_1d(n_dof_list(1)%array, exp_5)
    call monolis_alloc_I_1d(n_dof_list(2)%array, exp_5)
    call monolis_alloc_I_1d(n_dof_list(3)%array, exp_6)
    ...
    list_struct_R(2)%n = 5
    list_struct_R(3)%n = 6
    call monolis_alloc_R_1d(list_struct_R(1)%array, exp_5)
    call monolis_alloc_R_1d(list_struct_R(2)%array, exp_5)
    call monolis_alloc_R_1d(list_struct_R(3)%array, exp_6)
    ...
    call monolis_alloc_R_1d(check_array, exp_7)
    ...
    call monolis_alloc_R_1d(list_struct_R(1)%array, exp_6)
    call monolis_alloc_R_1d(list_struct_R(2)%array, exp_5)
    call monolis_alloc_R_1d(list_struct_R(3)%array, exp_7)
    list_struct_R(1)%n = 6
    list_struct_R(2)%n = 5
    list_struct_R(3)%n = 7
    list_struct_R(1)%array(1) = 1.0d0
    ...
    call gedatsu_merge_distval_R(exp_3, nodal_graphs, merged_nodal_graph, &
      n_dof_list, list_struct_R, merged_n_dof_list, merged_array_R)
    ...
    call monolis_alloc_R_1d(check_array, exp_8)
    check_array(1) = 1.0d0
    check_array(2) = 2.0d0
    check_array(3) = 3.0d0
    check_array(4) = 4.0d0
  ...
  subroutine gedatsu_merge_distval_I_test()
    ...
    list_struct_I(2)%n = 5
    list_struct_I(3)%n = 6
    call monolis_alloc_I_1d(list_struct_I(1)%array, exp_5)
    call monolis_alloc_I_1d(list_struct_I(2)%array, exp_5)
    call monolis_alloc_I_1d(list_struct_I(3)%array, exp_6)
    ...
    call gedatsu_merge_distval_I(exp_3, nodal_graphs, merged_nodal_graph, &
      n_dof_list, list_struct_I, merged_n_dof_list, merged_array_I)

    !> 確認
    call monolis_alloc_I_1d(check_n_dof_list, exp_7)
    call monolis_alloc_I_1d(check_array, exp_7)
    check_n_dof_list(1) = 1
    check_n_dof_list(2) = 1
    check_n_dof_list(3) = 1
    check_n_dof_list(4) = 1
    ...
    call monolis_alloc_I_1d(list_struct_I(1)%array, exp_6)
    call monolis_alloc_I_1d(list_struct_I(2)%array, exp_5)
    call monolis_alloc_I_1d(list_struct_I(3)%array, exp_7)
    list_struct_I(1)%n = 6
    list_struct_I(2)%n = 5
    list_struct_I(3)%n = 7
    list_struct_I(1)%array(1) = 1
    ...
    call monolis_alloc_I_1d(check_array, exp_8)
    check_array(1) = 1
    check_array(2) = 2
    check_array(3) = 3
    check_array(4) = 4
  ...
  subroutine gedatsu_merge_distval_C_test()
    ...
    call gedatsu_merge_nodal_subgraphs(exp_3, nodal_graphs, monoCOMs, &
    ...
    list_struct_C(2)%n = 5
    list_struct_C(3)%n = 6
    call monolis_alloc_C_1d(list_struct_C(1)%array, exp_5)
    call monolis_alloc_C_1d(list_struct_C(2)%array, exp_5)
    call monolis_alloc_C_1d(list_struct_C(3)%array, exp_6)
    ...
    call gedatsu_merge_distval_C(exp_3, nodal_graphs, merged_nodal_graph, &
      n_dof_list, list_struct_C, merged_n_dof_list, merged_array_C)

    !> 確認
    call monolis_alloc_I_1d(check_n_dof_list, exp_7)
    call monolis_alloc_C_1d(check_array, exp_7)
    check_n_dof_list(1) = 1
    check_n_dof_list(2) = 1
    check_n_dof_list(3) = 1
    check_n_dof_list(4) = 1
    ...
    call monolis_alloc_C_1d(list_struct_C(1)%array, exp_6)
    call monolis_alloc_C_1d(list_struct_C(2)%array, exp_5)
    call monolis_alloc_C_1d(list_struct_C(3)%array, exp_7)
    list_struct_C(1)%n = 6
    list_struct_C(2)%n = 5
    list_struct_C(3)%n = 7
    list_struct_C(1)%array(1) = (1.0d0, 1.0d0)
    ...
    call monolis_alloc_C_1d(check_array, exp_8)
    check_array(1) = (1.0d0, 1.0d0)
