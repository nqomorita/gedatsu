...
module mod_gedatsu_graph_merge_test
  ...
  subroutine gedatsu_merge_nodal_subgraphs_test()
    ...
    integer(kint) :: expected_0, expected_1, expected_2, expected_3, expected_4, expected_5, expected_6, expected_7, expected_8, expected_9, expected_12, expected_14, expected_15, expected_18, expected_22
    ...
    call gedatsu_graph_set_n_vertex(graphs(1), expected_5)
    call gedatsu_graph_set_n_vertex(graphs(2), expected_5)
    call gedatsu_graph_set_n_vertex(graphs(3), expected_6)
    ...
    call monolis_alloc_I_2d(edge, expected_2, expected_14)
    ...
    call gedatsu_graph_set_edge(graphs(1), expected_14, edge, .true.)
    ...
    edge(1,13) = 5; edge(2,13) = 2
    edge(1,14) = 5; edge(2,14) = 4
    call gedatsu_graph_set_edge(graphs(2), expected_14, edge, .true.)

    call monolis_dealloc_I_2d(edge)
    call monolis_alloc_I_2d(edge, expected_2, expected_18)
    edge(1,1) = 1; edge(2,1) = 2
    edge(1,2) = 1; edge(2,2) = 3
    edge(1,3) = 1; edge(2,3) = 4
    edge(1,4) = 1; edge(2,4) = 5
    ...
    call gedatsu_graph_set_edge(graphs(3), expected_18, edge, .true.)
    ...
    !> 結合
    call gedatsu_merge_nodal_subgraphs(expected_3, graphs, monoCOMs, merged_graph, merged_monoCOM, ORDER_DOMAIN_ID)

    !> 結合結果の確認
    call monolis_test_check_eq_I1("gedatsu_graph_merge_test nodal_graph case1 ORDER_DOMAIN_ID n_vertex", &
    & merged_graph%n_vertex, expected_7)
    call monolis_test_check_eq_I1("gedatsu_graph_merge_test nodal_graph case1 ORDER_DOMAIN_ID n_internal_vertex", &
    & merged_graph%n_internal_vertex, expected_5)
    call monolis_alloc_I_1d(check_vertex_domain_id, expected_7)
    ...
    call monolis_alloc_I_1d(check_vertex_id, expected_7)
    check_vertex_id(1) = 1
    check_vertex_id(2) = 4
    check_vertex_id(3) = 2
    check_vertex_id(4) = 3
    ...
    call monolis_alloc_I_1d(check_index, expected_8)
    check_index(1) = 0
    check_index(2) = 2
    check_index(3) = 6
    check_index(4) = 10
    ...
    call monolis_alloc_I_1d(check_item, expected_22)
    check_item(1) = 2
    check_item(2) = 3
    check_item(3) = 1
    check_item(4) = 3
    ...
    !> 結合
    call gedatsu_merge_nodal_subgraphs(expected_3, graphs, monoCOMs, merged_graph, merged_monoCOM, ORDER_NODAL_ID)
  ...
  subroutine gedatsu_merge_connectivity_subgraphs_test()
    ...
    integer(kint) :: expected_0, expected_1, expected_2, expected_3, expected_4, expected_5, expected_6, expected_9, expected_12, expected_14, expected_15, expected_18
    ...
    call gedatsu_graph_set_n_vertex(nodal_graphs(1), expected_5)
    call gedatsu_graph_set_n_vertex(nodal_graphs(2), expected_5)
    call gedatsu_graph_set_n_vertex(nodal_graphs(3), expected_6)
    ...
    edge(1,13) = 5; edge(2,13) = 2
    edge(1,14) = 5; edge(2,14) = 4
    call gedatsu_graph_set_edge(nodal_graphs(1), expected_14, edge, .true.)
    ...
    edge(1,13) = 5; edge(2,13) = 2
    edge(1,14) = 5; edge(2,14) = 4
    call gedatsu_graph_set_edge(nodal_graphs(2), expected_14, edge, .true.)
    ...
    edge(1,17) = 6; edge(2,17) = 1
    edge(1,18) = 6; edge(2,18) = 5
    call gedatsu_graph_set_edge(nodal_graphs(3), expected_18, edge, .true.)

    call monolis_com_initialize_by_self(monoCOMs(1))
    call monolis_com_initialize_by_self(monoCOMs(2))
    call monolis_com_initialize_by_self(monoCOMs(3))

    call gedatsu_merge_nodal_subgraphs(expected_3, nodal_graphs, monoCOMs, merged_nodal_graph, merged_monoCOM, ORDER_DOMAIN_ID)
    ...
    call gedatsu_graph_set_n_vertex(conn_graphs(1), expected_3)
    call gedatsu_graph_set_n_vertex(conn_graphs(2), expected_3)
    call gedatsu_graph_set_n_vertex(conn_graphs(3), expected_4)
    ...
    call monolis_dealloc_I_2d(edge)
    call monolis_alloc_I_2d(edge, expected_2, expected_9)
    ...
    call gedatsu_graph_set_edge(conn_graphs(1), expected_9, edge, .false.)
    ...
    edge(1,9) = 3; edge(2,9) = 4
    call gedatsu_graph_set_edge(conn_graphs(2), expected_9, edge, .false.)

    call monolis_dealloc_I_2d(edge)
    call monolis_alloc_I_2d(edge, expected_2, expected_12)
    edge(1,1) = 1; edge(2,1) = 1
    ...
    call gedatsu_graph_set_edge(conn_graphs(3), expected_12, edge, .false.)

    call gedatsu_merge_connectivity_subgraphs(expected_3, nodal_graphs, merged_nodal_graph, merged_monoCOM, &
    & expected_3, conn_graphs, merged_conn_graph)

    !> 結合結果の確認
    call monolis_test_check_eq_I1("gedatsu_graph_merge_test conn_graph case1 n_vertex", merged_conn_graph%n_vertex, expected_5)
    call monolis_test_check_eq_I1("gedatsu_graph_merge_test conn_graph case1 n_internal_vertex", &
    & merged_conn_graph%n_internal_vertex, expected_5)
    call monolis_dealloc_I_1d(check_vertex_domain_id)
    call monolis_alloc_I_1d(check_vertex_domain_id, expected_5)
    ...
    call monolis_alloc_I_1d(check_vertex_id, expected_5)
    check_vertex_id(1) = 1
    check_vertex_id(2) = 2
    check_vertex_id(3) = 3
    check_vertex_id(4) = 4
    ...
    call monolis_alloc_I_1d(check_index, expected_6)
    check_index(1) = 0
    check_index(2) = 3
    check_index(3) = 6
    check_index(4) = 9
    ...
    call monolis_alloc_I_1d(check_item, expected_15)
    check_item(1) = 1
    check_item(2) = 3
    check_item(3) = 2
    check_item(4) = 2
  ...
  subroutine gedatsu_merge_distval_R_test()
    ...
    integer(kint) :: expected_2, expected_3, expected_5, expected_6, expected_7, expected_8, expected_14, expected_18
    ...
    n_dof_list(2)%n = 5
    n_dof_list(3)%n = 6
    call monolis_alloc_I_1d(n_dof_list(1)%array, expected_5)
    call monolis_alloc_I_1d(n_dof_list(2)%array, expected_5)
    call monolis_alloc_I_1d(n_dof_list(3)%array, expected_6)
    ...
    list_struct_R(2)%n = 5
    list_struct_R(3)%n = 6
    call monolis_alloc_R_1d(list_struct_R(1)%array, expected_5)
    call monolis_alloc_R_1d(list_struct_R(2)%array, expected_5)
    call monolis_alloc_R_1d(list_struct_R(3)%array, expected_6)
    ...
    call gedatsu_merge_distval_R(expected_3, nodal_graphs, merged_nodal_graph, n_dof_list, list_struct_R, merged_n_dof_list, merged_array_R)

    !> 確認
    call monolis_alloc_I_1d(check_n_dof_list, expected_7)
    call monolis_alloc_R_1d(check_array, expected_7)
    ...
    call monolis_alloc_R_1d(list_struct_R(1)%array, expected_6)
    call monolis_alloc_R_1d(list_struct_R(2)%array, expected_5)
    call monolis_alloc_R_1d(list_struct_R(3)%array, expected_7)
    list_struct_R(1)%n = 6
    list_struct_R(2)%n = 5
    list_struct_R(3)%n = 7
    list_struct_R(1)%array(1) = 1.0d0
    ...
    call monolis_alloc_R_1d(check_array, expected_8)
    check_array(1) = 1.0d0
    check_array(2) = 2.0d0
    check_array(3) = 3.0d0
    check_array(4) = 4.0d0
  ...
  subroutine gedatsu_merge_distval_I_test()
    ...
    list_struct_I(2)%n = 5
    list_struct_I(3)%n = 6
    call monolis_alloc_I_1d(list_struct_I(1)%array, expected_5)
    call monolis_alloc_I_1d(list_struct_I(2)%array, expected_5)
    call monolis_alloc_I_1d(list_struct_I(3)%array, expected_6)
    ...
    call gedatsu_merge_distval_I(expected_3, nodal_graphs, merged_nodal_graph, n_dof_list, list_struct_I, merged_n_dof_list, merged_array_I)

    !> 確認
    call monolis_alloc_I_1d(check_n_dof_list, expected_7)
    call monolis_alloc_I_1d(check_array, expected_7)
    check_n_dof_list(1) = 1
    check_n_dof_list(2) = 1
    check_n_dof_list(3) = 1
    check_n_dof_list(4) = 1
    ...
    call monolis_alloc_I_1d(list_struct_I(1)%array, expected_6)
    call monolis_alloc_I_1d(list_struct_I(2)%array, expected_5)
    call monolis_alloc_I_1d(list_struct_I(3)%array, expected_7)
    list_struct_I(1)%n = 6
    list_struct_I(2)%n = 5
    list_struct_I(3)%n = 7
    list_struct_I(1)%array(1) = 1
    ...
    call monolis_alloc_I_1d(check_array, expected_8)
    check_array(1) = 1
    check_array(2) = 2
    check_array(3) = 3
    check_array(4) = 4
  ...
  subroutine gedatsu_merge_distval_C_test()
    ...
    list_struct_C(2)%n = 5
    list_struct_C(3)%n = 6
    call monolis_alloc_C_1d(list_struct_C(1)%array, expected_5)
    call monolis_alloc_C_1d(list_struct_C(2)%array, expected_5)
    call monolis_alloc_C_1d(list_struct_C(3)%array, expected_6)
    ...
    call gedatsu_merge_distval_C(expected_3, nodal_graphs, merged_nodal_graph, n_dof_list, list_struct_C, merged_n_dof_list, merged_array_C)

    !> 確認
    call monolis_alloc_I_1d(check_n_dof_list, expected_7)
    call monolis_alloc_C_1d(check_array, expected_7)
    check_n_dof_list(1) = 1
    check_n_dof_list(2) = 1
    check_n_dof_list(3) = 1
    check_n_dof_list(4) = 1
    ...
    call monolis_alloc_C_1d(list_struct_C(1)%array, expected_6)
    call monolis_alloc_C_1d(list_struct_C(2)%array, expected_5)
    call monolis_alloc_C_1d(list_struct_C(3)%array, expected_7)
    list_struct_C(1)%n = 6
    list_struct_C(2)%n = 5
    list_struct_C(3)%n = 7
    list_struct_C(1)%array(1) = (1.0d0, 1.0d0)
    ...
    call monolis_alloc_C_1d(check_array, expected_8)
    check_array(1) = (1.0d0, 1.0d0)
