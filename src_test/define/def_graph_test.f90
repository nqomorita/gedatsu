...
contains
  ...
  subroutine gedatsu_graph_initialize_test()
    ...
    call monolis_test_check_eq_I1("gedatsu_graph_initialize case 1", graph%n_vertex, n)

    call monolis_test_check_eq_I1("gedatsu_graph_initialize case 1", graph%n_internal_vertex, n)
  ...
  subroutine gedatsu_graph_finalize_test()
    ...
    call monolis_test_check_eq_I1("gedatsu_graph_finalize case 1", graph%n_vertex, n)

    call monolis_test_check_eq_I1("gedatsu_graph_finalize case 1", graph%n_internal_vertex, n)
