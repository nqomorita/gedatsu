...
contains
  ...
  subroutine gedatsu_simple_mesh2graph_convertor_test()
    ...
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor 1", n_vertex, expected_6)

    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor 2", index(1), expected_0)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor 3", index(2), expected_3)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor 4", index(3), expected_8)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor 5", index(4), expected_11)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor 6", index(5), expected_14)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor 7", index(6), expected_19)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor 8", index(7), expected_22)

    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 1", item(1), expected_2)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 2", item(2), expected_4)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 3", item(3), expected_5)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 4", item(4), expected_1)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 5", item(5), expected_3)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 6", item(6), expected_4)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 7", item(7), expected_5)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 8", item(8), expected_6)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 9", item(9), expected_2)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 10", item(10), expected_5)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 11", item(11), expected_6)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 12", item(12), expected_1)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 13", item(13), expected_2)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 14", item(14), expected_5)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 15", item(15), expected_1)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 16", item(16), expected_2)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 17", item(17), expected_3)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 18", item(18), expected_4)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 19", item(19), expected_6)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 20", item(20), expected_2)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 21", item(21), expected_3)
    call monolis_test_check_eq_I1("gedatsu_simple_mesh2graph_convertor a 22", item(22), expected_5)
