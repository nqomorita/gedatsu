program gedatsu_bc_partitioner_C
  ...
  if(is_get)then
    ...
    write(*,"(a)")"-ig {input graph filename}: (default) graph.dat.id"
  ...
  call monolis_input_bc_C(finame, n_bc, n_dof, i_bc, c_bc)
  ...
  do i = 1, n_domain
    ...
    call monolis_alloc_C_1d(c_bc_local, n_bc_local)
    ...
    call monolis_dealloc_C_1d(c_bc_local)
    call monolis_dealloc_I_1d(perm)
  enddo

  call monolis_mpi_finalize()
end program gedatsu_bc_partitioner_C
