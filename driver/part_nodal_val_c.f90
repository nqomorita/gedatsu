program gedatsu_nodal_val_c_partitioner
  ...
  call gedatsu_std_log_string("gedatsu_nodal_val_c_partitioner")
  ...
  do i = 1, n_domain
    call monolis_alloc_C_2d(val_local, n_dof, graph(i)%n_vertex)
    ...
    call monolis_output_distval_c(foname_full, label, graph(i)%n_vertex, n_dof, val_local)
